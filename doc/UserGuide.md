...
### Finding all persons containing any case-insensitive keyword in their name: `find`
Finds persons whose names contain any of the given keywords.<br> and ignore cases.
